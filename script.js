(() => {
  ...
  Object.entries(localeInfo).forEach(([locale, info]) => {
  ...
  if (themeHeader) themeButton.insertAdjacentElement('beforebegin', languageSelect);
